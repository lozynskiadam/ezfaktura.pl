...
return [
    ...
    */
    ...
    'max_decimal_places' => 'Maksymalnie :places miejsc dziesiętnych.',
    'current_password' => 'Hasło jest nieprawidłowe.',
    'belongs_to_user' => 'Obiekt nie istnieje.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'signature.name.regex' => 'ID może zawierać tylko małe litery, cyfry i znak "-".',
    'signature.syntax.regex' => 'To pole musi zawierać "{counter}"',
];
