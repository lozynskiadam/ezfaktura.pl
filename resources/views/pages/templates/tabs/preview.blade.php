      ...
      <div class="row align-items-center mb-3">
        ...
        <div class="col-auto">
          <a href="#" class="btn btn-primary btn-labeled">
            <i class="fa fa-download" style="padding: 12px 0 12px 0;"></i> Pobierz pdf
          </a>
        </div>
      </div>
      ...
      <div class="card card-invoice">
        ...
        <div class="card-footer">
          ...
          <p class="text-muted mb-0">
            ...
            should you need us to add VAT or anything else to this order, it's super easy since this is a
