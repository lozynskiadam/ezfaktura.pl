<div class="row">
  ...
  <div class="col-md-4">
    ...
    <button class="btn btn-primary btn-sm form-control mb-1 act-set-paid" @if($invoice->is_paid) disabled @endif>
      @if(!$invoice->is_paid)
    ...
    <button class="btn btn-primary btn-sm form-control mb-1 act-set-sent" @if($invoice->is_sent) disabled @endif>
      @if(!$invoice->is_sent)
    ...
    <button class="btn btn-danger btn-sm form-control mb-1 act-delete">
