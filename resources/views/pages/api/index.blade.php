  ...
  <div class="page-navs bg-white">
    <div class="nav-scroller">
      <div class="nav nav-tabs nav-line nav-color-primary">
        <a class="nav-link active show" data-toggle="tab" href="#tab-key"><i
            class="fa fa-key mr-1"></i> {{ __('Klucz API') }}</a>
        <a class="nav-link" data-toggle="tab" href="#tab-docs"><i class="fa fa-book mr-1"></i> {{ __('Dokumentacja') }}
        </a>
        <a class="nav-link" data-toggle="tab" href="#tab-playground"><i
            class="fa fa-vial mr-1"></i> {{ __('Playground') }}</a>
