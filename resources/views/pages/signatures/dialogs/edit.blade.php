<form>
  ...
  <div class="form-group row">
    ...
    <label for="mode" class="col-form-label col-md-2">{{ __('translations.signatures.counter_padding') }}</label>
    <div class="col-md-3">
      <div class="input-group">
        <input type="number" min="0" max="10" class="form-control" id="padding" name="padding"
               value="{{ $signature->padding ?? '0' }}">
        <div class="input-group-append">
          <span class="input-group-text">{{ __('translations.signatures.counter_places') }}</span>
        </div>
      </div>
    </div>
    <div class="col-md-10 offset-md-2 validation-block"></div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-md-10 offset-md-2">
      <div class="px-2 py-1 text-info b"
           style="background: #f5f5f5; border: 1px inset #fafafa80; margin-top: -3px; border-radius: 3px;">
        <a class="act-placeholder mr-1" href="#" data-toggle="tooltip" data-placement="bottom"
           title="{{ __('translations.signatures.syntax.counter') }}">{counter}</a>
        <a class="act-placeholder mr-1" href="#" data-toggle="tooltip" data-placement="bottom"
           title="{{ __('translations.signatures.syntax.month') }}">{year}</a>
        <a class="act-placeholder mr-1" href="#" data-toggle="tooltip" data-placement="bottom"
           title="{{ __('translations.signatures.syntax.year') }}">{month}</a>
      </div>
